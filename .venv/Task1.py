...
with imageio.get_writer('./video/Task1-random.gif', mode='I') as writer:
...
report_file = os.path.join(report_dir, 'Task1_report.txt')

try:
    with open(report_file, 'w') as f:
        f.write(f"CartPole-v0 Random Agent Report\n")
        f.write(f"====================================\n")
